...
def main_worker(gpu, opts):
    ...
    model_config = GPTConfig(train_dataset.block_num, embd_pdrop=0.0, resid_pdrop=0.0, attn_pdrop=0.0,
                             n_layer=opts.n_layer, n_head=opts.n_head, n_embd=opts.n_embd, BERT=opts.BERT,
                             use_gelu2=opts.GELU_2, dynamic_weight=opts.dynamic_weight, class_size=opts.class_size)
    ...
    train_config = TrainerConfig(max_epochs=train_epochs, batch_size=opts.batch_size,
                                 ...
                                 num_workers=8, GPU_ids=opts.gpu, BERT=opts.BERT,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask_path', type=str, default='/mnt/datadisk0/final/train/masks/')
